  ...
  return (
    <>
      <Badge anchorOrigin={{horizontal: "left", vertical: "top"}} badgeContent={<EditButtonIcon />}>
        <Box className={classes.background} mb={2} border={1} borderRadius={5} width="100%" boxShadow={3} display="inline-flex" justifyContent="center" alignItems="center" flexWrap="wrap">
          <Box m={1} p={1} flexGrow={2}>
            <Typography align="center" noWrap={true} variant="body1" display="inline">
              Take out the bin
            </Typography>
          </Box>
          <Box m={1} p={1} alignItems="center" flexGrow={1}>
            <Chip label="Workout" variant="outlined"/>
          </Box>
          <Box m={1} flexGrow={1} p={1} minWidth={50}>
            <Slider
              marks={marks}
              max={4}
              min={0}
